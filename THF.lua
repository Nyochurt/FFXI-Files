...
function init_gear_sets()
    ...
    sets.TreasureHunter = {hands={ name="Asn. Armlets +2", augments={'Enhances "Perfect Dodge" effect',}}}
    sets.ExtraRegen = {head="Mengado +1"}
    ...
    head={ name="Herculean Helm", augments={'Accuracy+1 Attack+1','"Triple Atk."+3','DEX+9','Accuracy+14','Attack+12',}},
    body={ name="Herculean Vest", augments={'Weapon skill damage +5%','Accuracy+15',}},
    ...
    legs={ name="Herculean Trousers", augments={'Mag. Acc.+19 "Mag.Atk.Bns."+19','Magic burst dmg.+4%','MND+10','Mag. Acc.+8','"Mag.Atk.Bns."+15',}},
    feet={ name="Herculean Boots", augments={'Accuracy+23 Attack+23','"Triple Atk."+2','Accuracy+11','Attack+6',}},
    neck="Fotia Gorget",
    waist="Fotia Belt",
    ...
    sets.idle = {ammo="Seeth. Bomblet +1",
    ...
    head={ name="Herculean Helm", augments={'Accuracy+1 Attack+1','"Triple Atk."+3','DEX+9','Accuracy+14','Attack+12',}},
    body={ name="Herculean Vest", augments={'Weapon skill damage +5%','Accuracy+15',}},
   -- hands={ name="Herculean Gloves", augments={'Accuracy+26','"Triple Atk."+3','MND+5',}},
    hands={ name="Asn. Armlets +2", augments={'Enhances "Perfect Dodge" effect',}},
    legs={ name="Samnuha Tights", augments={'STR+10','DEX+10','"Dbl.Atk."+3','"Triple Atk."+3',}},
    feet={ name="Herculean Boots", augments={'Accuracy+23 Attack+23','"Triple Atk."+2','Accuracy+11','Attack+6',}},
    neck="Clotharius Torque",
    ...
    head="Mummu Bonnet +1",
    body={ name="Herculean Vest", augments={'Accuracy+23 Attack+23','Weapon skill damage +2%','STR+5','Accuracy+15',}},
    hands="Mummu Wrists +1",
    legs={ name="Herculean Trousers", augments={'Accuracy+23 Attack+23','Crit.hit rate+1','Accuracy+12',}},
    feet="Mummu Gamash. +1",
